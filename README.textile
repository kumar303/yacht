...
The app is hosted right here on "github pages":http://kumar303.github.com/yacht/
but you must pay
for it on the "Mozilla Marketplace dev site":https://marketplace-dev.allizom.org/app/private-yacht/
...
Check out the "receipt verifier library":https://github.com/mozilla/receiptverifier
...
like "this one in Python":http://receipts.readthedocs.org/en/latest/ .
